import { loadPersons, getFractiesOfPerson } from './person.js';
...
async function selectFractie(fractie) {
    if (selectedCard) {
        ...
        if (fractieOfPerson === fractie.name) {
            ...
            alert(`De fractie van ${selectedCard.object.Roepnaam} ${selectedCard.object.Achternaam} is inderdaad ${fractie.name}.`);
        } else {
            alert(`De fractie van ${selectedCard.object.Roepnaam} ${selectedCard.object.Achternaam} is niet ${fractie.name}, maar ${fractieOfPerson}.`);
        }
    }
}